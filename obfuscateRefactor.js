...
const checkLetters = {
  a: function(inputLetter) {
    return replaceLetter(inputLetter, "a", "4");
  },
  e: function(inputLetter) {
    return replaceLetter(inputLetter, "e", "3");
  },
  o: function(inputLetter) {
    return replaceLetter(inputLetter, "o", "0");
  },
  l: function(inputLetter) {
    return replaceLetter(inputLetter, "l", "1");
  }
};
